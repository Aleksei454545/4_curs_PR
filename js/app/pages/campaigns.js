export const campaigns = {
    ...
    methods:{
        ...
        del:async function() {
            if(await this.$refs.header.$refs.msg.confirmFun("Please confirm to delete this campaign!")){
                var self = this;
                var data = self.parent.toFormData(self.parent.formData);
    ...
    line:function(item) {
        setTimeout(function() {
            ...
            const ctx = document.getElementById('myChart'); // ID должен совпадать с canvas выше
