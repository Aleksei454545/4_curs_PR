    ...
    actionStatistic:function(){
        ...
        line:function(item){
            setTimeout(function(){
                ...
                document.getElementById('chartOuter').innerHTML = '<div id="chartHints"><div class="chartHintsViews">Views</div><div class="char'
...
<div class="table" v-if="tab == 1 && data.sites.length > 0">
    <table>
        <thead>
            <tr>
                <th class="id"></th>
...
<div v-if="tab==2">
    <div class="flex panel">
        ...
        <div class="w20 al ptb15">
            <a class="btnS" href="#" @click.prevent="parent.formData={};$refs.payment.active=1"><i class="fas fa-plus"></i> Add paymant</a>
        </div>
    </div>
</div>
...
<div class="table" v-if="tab == 2 && data.payments.length > 0">
    <table>
        <thead>
            <tr>
                <th class="id">#</th>
...
<div v-if="tab==0">
    ...
    <div class="table" v-if="tab == 0 && data.statistics.length > 0">
        <table>
            <thead>
                <tr>
                <th class="id"></th>
